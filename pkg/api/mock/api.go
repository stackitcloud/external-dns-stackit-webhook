...
// Source: internal/adapter/api/api.go
...
// PropertyValuesEqual mocks base method.
func (m *MockProvider) PropertyValuesEqual(name, previous, current string) bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PropertyValuesEqual", name, previous, current)
	ret0, _ := ret[0].(bool)
	return ret0
}

// PropertyValuesEqual indicates an expected call of PropertyValuesEqual.
func (mr *MockProviderMockRecorder) PropertyValuesEqual(name, previous, current interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PropertyValuesEqual", reflect.TypeOf((*MockProvider)(nil).PropertyValuesEqual), name, previous, current)
}
