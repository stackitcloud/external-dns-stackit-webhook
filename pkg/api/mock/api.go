...
//
//	mockgen -destination=./mock/api.go -source=./api.go Provider
//
...
func (mr *MockApiMockRecorder) Listen(port any) *gomock.Call {
...
func (mr *MockApiMockRecorder) Test(req any, msTimeout ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{req}, msTimeout...)
...
func (mr *MockProviderMockRecorder) AdjustEndpoints(endpoints any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProviderMockRecorder) ApplyChanges(ctx, changes any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProviderMockRecorder) Records(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
